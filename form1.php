...
<body>
	<h2 style="float: left; margin:30px 0px 0px 20px;">Dhruv Bhanderi</h2>
	<h2 style="float:left; margin: 30px 0px 0px 490px">Day-1</h2>
	<h2 style="float: right; margin: 30px 20px 0px 0px;">internship</h2><br>
